...
declare module '$env/static/private' {
	...
	export const ANTIGEN_LOG: string;
	...
	export const SPICETIFY_CONFIG: string;
	...
	export const VSCODE_RESOLVING_ENVIRONMENT: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		XPC_FLAGS: string;
		TMUX_PANE: string;
		VSCODE_RESOLVING_ENVIRONMENT: string;
